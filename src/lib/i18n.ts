  ...
  ru: {
    ...
    af: {
      ...
      logistics: {
        ...
        body:
          'Компания ArtFlowers имеет собственную транспортную компанию, осуществляющую доставку и перевозку товара наших клиентов с соблюдением графика поставок и всеми необходимыми нормами — от документального сопровождения до точного соблюдения температурного режима.',
      },
      contacts: {
        title: 'Контакты',
