  ...
  ru: {
    ...
    af: {
      ...
      logistics: {
        ...
        body:
          'Компания ArtFlowers имеет собственную транспортно - логистическую компанию, осуществляющую доставку и перевозку товара наших партнеров/клиентов с соблюдением графиком поставок и всех необходимых норм  - от документального сопровождения до точного соблюдения температурного режима.',
      },
      contacts: {
        title: 'Контакты',
  ...
  kz: {
    ...
    af: {
      ...
      whyUs: {
        ...
        intro:
          'Жеке автопарк, елдер бойынша өкілдіктер және әлемнің жетекші гүл өсіру аудандарынан тікелей жеткізілімдер - біз гүлді кесу сәтінен бастап сіздің есігіңізге дейінгі әрбір кезеңді қадағалаймыз.',
      ...
      footer: {
        ...
        offerP2:
          '1.1. Бұл Оферта Қазақстан Республикасы Азаматтық кодексінің 395-бабына сәйкес жария шарт болып табылады.',
