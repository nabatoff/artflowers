...
const SEO = ({
  title = 'ArtTime — Где важна надежность | Международные перевозки',
  description = 'ArtTime — транспортно-логистическая компания полного цикла с собственным автопарком рефрижераторов. Международные перевозки через 12+ стран.',
  keywords = 'логистика, международные перевозки, рефрижераторные перевозки, грузоперевозки, транспортная компания, Казахстан, art-time, arttime',
  ...
  useEffect(() => {
    ...
    updateMetaTag('og:image:alt', 'ArtTime - Международные грузоперевозки', true);
    updateMetaTag('og:type', ogType, true);
    updateMetaTag('og:url', canonicalUrl, true);
    updateMetaTag('og:site_name', 'ArtTime', true);
