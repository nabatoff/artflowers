...
const HeroBlack = () => {
  ...
  return <section className="relative h-screen md:min-h-screen overflow-hidden pt-0 md:pt-16 flex items-center justify-start">
      ...
      {/* Content */}
      <div className="container lg:px-8 relative z-10 md:py-20 md:items-center min-h-full w-full px-[72px] flex items-start justify-start gap-0 my-[11px] py-[65px] mx-[47px]">
        <div
        className="min-w-0 w-full max-w-xl pb-8 md:pb-0 flex-wrap text-left relative md:absolute md:left-[-212px] md:top-[62px] leading-[1.2] md:leading-[34px] text-3xl sm:text-4xl md:text-[70px] font-semibold break-words flex items-start justify-start">
