...
const HeroBlack = () => {
  ...
  return <section className="relative h-screen min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 py-20 flex items-end md:items-center min-h-full w-full">
        <div
          className="min-w-0 w-full max-w-xl pb-8 md:pb-0 flex flex-wrap text-left relative md:absolute md:left-[-212px] md:top-[120px] leading-[1.2] md:leading-[34px] text-3xl sm:text-4xl md:text-[70px] font-semibold break-words"
        >
          {/* Main Headline */}
