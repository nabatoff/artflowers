...
/* ─── About ─── */
const AboutV2 = () => {
  const countries = ['🇳🇱 Нидерланды', '🇨🇳 Китай', '🇪🇨 Эквадор', '🇰🇪 Кения', '🇨🇴 Колумбия', '🇲🇾 Малайзия'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-6">
            ...
            <p className="text-white/70 leading-relaxed">
              <strong className="text-white">Более 17 лет</strong> мы поставляем людям свежесть и красоту в виде большого ассортимента качественных цветов и растений.
            </p>
            <p className="text-white/70 leading-relaxed">
              С годами наша компания стала ключевым игроком в цветочной индустрии, устанавливая прочные партнёрства с крупнейшими производителями <strong className="text-white">Нидерландов, Китая, Эквадора, Кении, Колумбии, Малайзии</strong> и других стран.
            </p>
